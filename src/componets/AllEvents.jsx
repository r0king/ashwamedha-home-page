        ...
        slides.forEach((slide) => {
            slidesHtml.push(
                <div index={this.state.slides.length}>
                    <div className="main flex flex-shrink relative sm:w-auto lg:max-w-[15vw] max--[75vw] sm:max-w-[20vw] max-h-[450px] transition duration-500 hover:scale-110 ">
                        <img
                            src={slide.src}
                        ...
                        <div className="absolute w-full h-full p-6 bg-gray-800 bg-opacity-20 flex-shrink-0 ">
                            ...
                            <button className="align lg:mt-20 lg:ml-9 sm:mt-20 sm:-ml-9 justify-center rounded-full absolute  bg-black
                             hover:bg-orange-400 border-2 border-orange-400 sm:min-h-6 min-w-8 lg:max-h-9 lg:max-w-11  text-white lg:text-sm  font-semibold">
                        View More
                      </button>
                            </div>
