        ...
        <section>
          <div className="">
            <div className="container px-6 py-10 mx-auto">
              <h1
                id="guest"
                className="text-3xl font-semibold text-center capitalize lg:text-4xl text-neutral-content"
              >
                Special Guests
              </h1>
              <div className="flex justify-center mx-auto mt-6 text-primary">
          ...
          <div className="container flex items-center justify-center px-6 py-16 mx-auto -mt-20  ">
            <div className="mt-[4vh]  h-[60vh] w-[40vh] flex  flex-col items-center p-4 border sm:p-6 rounded-xl  ">
              <img
