  ...
  <div className="py-20 text-white opacity-60">
    <div className="container flex flex-col items-center mx-auto my-12 md:flex-row md:my-24">
      <div className="flex flex-col items-start justify-center w-full p-8 lg:w-1/3">
        <h1 className="p-2 text-3xl text-neutral-content md:text-5xl tracking-loose">ASHWAMEDHA</h1>
        <h2 className="mb-2 text-3xl leading-relaxed md:text-5xl md:leading-snug">Space : The Timeless Infinity
        </h2>
        <p className="mb-4 text-sm md:text-base text-gray-50">Explore your favourite events and
