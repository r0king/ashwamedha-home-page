       ...
       <section className="bg-grey-900">
        <div className="container px-6 py-10 mx-auto flex ">
          <div className="lg:-mx-6 lg:flex lg:items-center justify-center flex-auto sm:flex sm:items-center ">
            <img className="object-cover object-center lg:w-1/4 sm:w-1/2 lg:mx-6 w-full h-96 rounded-lg lg:h-full sm:h-full" src="https://images.unsplash.com/photo-1499470932971-a90681ce8530?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" />
            <div className="lg:w-1/2 lg:px-6 lg:mt-0 sm:w-1/2 sm:ml-6">
              <p className="text-3xl font-semibold text-justify text-orange-400 mt-2"><span className="inline-block w-16 h-0.5 bg-orange-400 rounded-full mb-2 mr-12" />ABOUT US</p>
              <p className="text-5xl font-semibold text-justify text-white mt-2">Who We Are</p>
              ...
              <a href='#'><p className='text-xl font-semibold'><span className="inline-block w-0.5 h-4 bg-orange-400 rounded-full mt-4 mr-4" />READ MORE<span className="inline-block w-0.5 h-4 bg-orange-400 rounded-full mt-4 ml-4"/></p></a>
            </div>
          </div>
        </div>
      </section>
